...
// Tashqaridan berilgan qiymat ustun turadi — turli ish vaqtlarini sinash uchun.
process.env.WORK_START = process.env.WORK_START || '00:00';
process.env.WORK_END = process.env.WORK_END || '23:45';
